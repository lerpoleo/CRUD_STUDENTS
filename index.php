...
<head>
    ...
    <title>CRUD_STUDENTS</title>
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.100.2/css/materialize.min.css">
    <style>
    :root {
      --color-primary: #41b2b8;
...
<!-- Todo aplicacion con el ID APP de VUE.js -->
<main id="app" class="container center">

<section class="row valign-wrapper">
<div class="col s12 m3">
<img class="responsive-img" src="./imagenes/logo.png" alt="lervis.js">
</div>

<div class="col s12 m6">
<h3>App CRUD_STUDENTS</h3>
<h5>(Con PHP + MySQL)</h5>
</div>

<div class="col s12 m3">
<img class="responsive-img" src="./imagenes/logo2.png" alt="lervis.js">
</div>
</section>
